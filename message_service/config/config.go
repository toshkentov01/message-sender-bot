...
func load() *Config {
	return &Config{
		...
		TelegramApiToken:       cast.ToString(getOrReturnDefault("TELEGRAM_APITOKEN", "")),
		TelegamChannelUsername: cast.ToString(getOrReturnDefault("TELEGRAM_CHANNEL_USERNAME", "")),
	}
}
